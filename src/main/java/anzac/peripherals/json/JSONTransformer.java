package anzac.peripherals.json;
...
public class JSONTransformer implements Transformer {
	...
	public String transformClass(final ApiClass apiClass) {
		...
		builder.append("{\"type\": \"" + apiClass.type + "\", ");
	...
	public String transformEventDetail(final ApiEvent apiEvent, final String className) {
		final StrBuilder builder = new StrBuilder();
		builder.append("{\"name\": \"" + apiEvent.name + "\", ");
		builder.append("\"description\": \"" + processText(className, apiEvent.description) + "\", ");
	...
	public String transformMethodDetail(final ApiMethod apiMethod, final String className) {
		final StrBuilder builder = new StrBuilder();
		builder.append("{\"name\": \"" + apiMethod.name + "\", ");
		builder.append("\"description\": \"" + processText(className, apiMethod.description) + "\", ");
		...
		builder.append("\"returns\": \"" + apiMethod.returnType + "\", ");
	...
	public String transformParameter(final ApiParameter apiParameter, final String className) {
		return "{\"name\": \"" + apiParameter.name + "\", \"description\": \""
				+ processText(className, apiParameter.description) + "\", }";
	}

	@Override
	public String transformBlock(final Block block) {
		final StrBuilder builder = new StrBuilder();
		builder.append("{\"name\": \"" + block.name + "\", ");
		builder.append("\"description\": \"" + processText(block.name, block.description) + "\", ");
		...
		if (block.peripheral != null) {
			builder.append("\"peripheral\": " + transformClass(block.peripheral) + ", ");
		}
		builder.append("}");
		return builder.toString();
	}
	...
	public String transformItem(final Item item) {
		...
		builder.append("\"description\": \"" + processText(item.name, item.description) + "\", ");
		builder.append("}");
		return builder.toString();
	}
